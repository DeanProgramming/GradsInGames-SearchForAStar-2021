...
public class BasicExplosiveType : Missile
{
    [HideInInspector] public BasicExplosiveType[] missiles;
    ...
    public void Explode()
    {
        ...
        missileSpawning.StartCoroutine("UpdateRecordnewBasic");
        Destroy(gameObject);
    }
